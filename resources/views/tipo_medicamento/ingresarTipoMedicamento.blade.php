...
@include('plantillas/navbar')
    ...
    <div class="text-center" style="width: 40%; height: 100%; margin-left: 30%; margin-top: 2%; color: #212121;">
        <form action="{{url('/insertartipomedicamento-c')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
            <div class="float-center" style="margin-bottom: 5%">
                  <h2 class="float-center">INGRESO DE TIPO MEDICAMENTO</h2>
              </div>
              <div class="row espacio">
                  ...
                  <div class="col">
                      <input type="text" name="nombre_tipo_medicamento" class="form-control">
                  </div>
              </div>
    <br>
